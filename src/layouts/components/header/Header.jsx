...
import { ArrowDownIcon, LogoIconDark, WalletIcon } from "~/components/Icon";
  ...
  return (
    <div className={cx("header")}>
      ...
      <div className={cx("right")}>
        <Tippy className={cx("tooltip")} offset={[-30, 10]} content="Wallet">
          <div className={cx("chooseToken")}>
            <img
              className={cx("brand")}
              ...
              alt=""
            />
            <ArrowDownIcon className={cx("arrowIcon")} />
          </div>
        </Tippy>
        <Tippy className={cx("tooltip")} content="Wallet">
          <Link to={"/portfolio"} className={cx("wallet")}>
