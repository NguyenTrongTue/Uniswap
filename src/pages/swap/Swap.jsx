    ...
    <div className={cx("home")}>
      <div className={cx("container")}>
          ...
          <div className={cx("box")}>
            <div className={cx("boxTop")}>
              ...
              <div className={cx("chooseToken")}>
                ...
                <div className={cx("tokenName")}>ETH</div>
                <KeyboardArrowDownOutlinedIcon className={cx("arrowIcon")} />
              </div>
            </div>
            <div className={cx("boxBottom")}>
              <span className={cx("amount")}>$2.02M</span>
              <span className={cx("balance")}>Balance: 0</span>
            </div>
        ...
        <div className={cx("bottom")}>
          ...
          {/* <span className={cx("notSelected")}>Select a token</span> */}
        </div>
      </div>
    </div>
  );
